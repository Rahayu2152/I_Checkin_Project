                    ...
                    <div class="x_content">
                        ...
                        <form method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    No Telp : <input class="form-control" placeholder="No Telp" name="u_mobile" type="text" value="<?php echo $userRow['mobile']; ?>" required>
                                </div>
                                <div class="form-group">
                                    Jabatan Karyawan : <input class="form-control" placeholder="Jabatan Karyawan" name="u_position" type="text" value="<?php echo $userRow['position']; ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    Jenis Kelamin : <?php
                                    if(strcmp("lakilaki", $userRow['gender']) == 0)
                                        echo '<input type="radio" name="u_gender" value="lakilaki" checked> Laki - Laki';
                                    else
                                        echo '<input type="radio" name="u_gender" value="lakilaki"> Laki - Laki';
                                    if(strcmp("perempuan",$userRow['gender']) == 0)
                                        echo ' &nbsp<input type="radio" name="u_gender" value="perempuan" checked> Perempuan';
                                    else
                                        echo '&nbsp <input type="radio" name="u_gender" value="perempuan"> Perempuan';
                                    ?>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    if(strcmp("karyawan",$userRow['type'])==0)
                                    echo ' &nbsp<input type="radio" name="u_type" value="karyawan" checked> Karyawan';
                                    else
                                    echo '&nbsp <input type="radio" name="u_type" value="karyawan"> Karyawan';
                                    }
                                    ?>
                                </div>
                                <br/>
